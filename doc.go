/*
package anylogger solves the problem of abstracting away a logging frontend from a logging backend.
...
This is exactly the problem anylogger tries to solve.
